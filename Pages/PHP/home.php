...
<html lang="PTBR" class="scroll-smooth">
  <head>
    ...
    <title>
      Telecall - Soluções completas em telefonia e internet
    </title>
    <link
      rel="shortcut icon"
      ...
      <div class="container">
        <div class="relative -mx-4 flex items-center justify-between">
          <div class="w-60 max-w-full px-4">
            <a href="home.php" class="navbar-logo block w-full py-5">
              <img
          ...
          <div class="w-full px-4">
            ...
            >
              ...
              >
                ...
                Especialistas em telefonia e internet
              </p>
              <ul class="mb-10 flex flex-wrap items-center justify-center">
                <li>
                  <a
                    href="https://wa.me/5521936180100"
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4">
            <div class="mb-12 max-w-[620px] lg:mb-20">
              ...
              >
                +800 km de rede no Rio de Janeiro
              </h2>
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
              Soluções de acesso que possibilitam as empresas a se conectarem a 
              internet com a máxima qualidade, disponibilidade e segurança.  
        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".1s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Garantimos o melhor preço do mercado ou seu dinheiro de volta
              </p>
              <a
                href="javascript:void(0)"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            >
              ...
              <h4 class="mb-3 text-xl font-bold text-dark">
                Pontos de disponibilidade
              </h4>
              <p class="mb-8 text-body-color lg:mb-11">
                Estamos Disponíveis em mais de 3 países
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-body-color hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp group mb-12 bg-white" data-wow-delay=".2s">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Temos o menor ping disponivel no mercado
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-body-color hover:text-primary"
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/4">
            ...
            > 
             ...
             <h4 class="mb-3 text-xl font-bold text-dark">
              ...
              <p class="mb-8 text-body-color lg:mb-11">
                Todos os nossos servidores são de altíssima qualidade 
              </p>
              <a
                href="javascript:void(0)"
                class="text-base font-medium text-body-color hover:text-primary"
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Para Planos Personalizados entre em contato com um de nossos representantes 
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Aqui você encontra as duvidas mais frequentes dos nossos clientes 
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="-mx-4 flex flex-wrap">
              ...
              <button class="faq-btn flex w-full items-center text-left">
                ...
                <div class="w-full">
                  <h4 class="text-base font-semibold text-black sm:text-lg">
                    Como realizar um teste de velocidade? <br><br>
                  </h4>
                </div>
              </button>
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Acessar o site https://www.speedtest.net <br>
          ...
          <div class="w-full px-4 lg:w-1/2">
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Para garantir resultados mais precisos é necessário considerar algumas questões:
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  Numa máquina windows, abrir o Prompt de Comando.
                  Digitar PING "endereço de destino" (exemplo: www.telecall.com)
                  A resposta será a quantidade de pacotes enviada, a quantidade recebida e a porcentagem de perda (caso houver).
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div class="faq-content hidden pl-[62px]">
                <p class="py-3 text-base leading-relaxed text-body-color">
                  A perda de pacotes ocorre quando um conteúdo digital, não chega ao seu destino.
                  Essa situação pode acontecer por falha de equipamento, problema no cabo de rede, alto consumo de banda ou por baixa qualidade da conexão.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="mx-4 w-full">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center lg:mb-20">
              ...
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Relato de alguns dos nossos clientes e suas experiências com os nossos serviços
              </p>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div class="ud-testimonial-content mb-6">
                <p class="text-base tracking-wide text-body-color">
                    ...
                    “Nossos membros estão tão impressionados. A qualidade do serviço da Telecall sempre esta nos surpreendendo.
.
                </p>
              </div>
              <div class="ud-testimonial-info flex items-center">
                ...
                <div class="ud-testimonial-meta">
                  <h4 class="text-sm font-semibold">Paulo Cunha</h4>
                  <p class="text-xs text-[#969696]">CEO @ AWS Brasil
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-content mb-6">
                <p class="text-base tracking-wide text-body-color">
                  “As parcerias com a Telecall são de grande inportancia para nos da unisuam. 
                </p> <br><br>
              </div>
              <div class="ud-testimonial-info flex items-center">
                <div
                ...
                <div class="ud-testimonial-meta">
                  <h4 class="text-sm font-semibold">Arapuan Motta Netto</h4>
                  <p class="text-xs text-[#969696]">Reitor @ Unisuam BS</p>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full px-4 md:w-1/2 lg:w-1/3">
            ...
            >
              ...
              <div class="ud-testimonial-content mb-6">
                <p class="text-base tracking-wide text-body-color">
                  “A Telecall nos proporciona uma Infraestrutura excepcional para a realização dos nossos projetos.
                </p> <br>
              </div>
              <div class="ud-testimonial-info flex items-center">
                <div
                ...
                <div class="ud-testimonial-meta">
                  <h4 class="text-sm font-semibold">Roberto Medina</h4>
                  <p class="text-xs text-[#969696]">CEP @ Rock in Rio</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="ud-brands-logo flex flex-wrap items-center">
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a
                    href="https://aws.amazon.com/pt/?nc2=h_lg"
                    target="_blank"
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a
                    href="https://www.unisuam.edu.br"
                    target="_blank"
                    rel="nofollow noopner"
                  >
                    <img
                      src="assets/images/brands/unisuam.png"
                      alt="ayroui"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="assets/images/brands/rock.png"
                      alt="uideck"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  <a
                    href="https://maratonadorio.com.br"
                    target="_blank"
                    rel="nofollow noopner"
                  >
                    <img
                      src="assets/images/brands/rio.png"
                      alt="graygrids"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
                ...
                <div class="ud-single-logo mr-10 mb-5 max-w-[140px]">
                  ...
                  >
                    <img
                      src="assets/images/brands/cufa.png"
                      alt="lineicons"
                      class="grayscale duration-300 hover:filter-none"
                    />
                  </a>
          ...
          <div class="w-full px-4">
            <div class="mx-auto mb-[60px] max-w-[620px] text-center">
              ...
              <p
                class="text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed"
              >
                Colaboradores em destaque da nossa equipe.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="-mx-4 flex flex-wrap justify-center">
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="wow fadeInUp mb-10" data-wow-delay=".15s">
              ...
              <div class="text-center">
                <h4 class="mb-2 text-lg font-medium text-dark">Carlos Alberto Gomes</h4>
                <p class="mb-5 text-sm font-medium text-body-color">
                  Protagonista
                </p>
                <div class="flex items-center justify-center">
            ...
            <div class="ud-contact-content-wrapper">
              ...
              <div class="mb-12 flex flex-wrap justify-between lg:mb-0">
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    <h5 class="mb-6 text-lg font-semibold">Localização</h5>
                    <p class="text-base text-body-color">
                      Av. das Américas, 3434 - Bloco 1 - 505 - Barra da Tijuca, Rio de Janeiro - RJ, 22640-102
                ...
                <div class="mb-8 flex w-[330px] max-w-full">
                  ...
                  <div>
                    <h5 class="mb-6 text-lg font-semibold">Fale Conosco</h5>
                    <p class="text-base text-body-color">suporte@telecall.com</p>
                    <p class="text-base text-body-color">
                      (21) 3030-1010
                    </p>
                  </div>
      ...
      <div class="container">
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div class="mb-10 w-full">
              ...
              <p class="mb-7 text-base text-[#f3f4fe]">
                Referência em internet e telefonia para
                empresas desde 1998, a Telecall acumula mais
                de 500 interconexões mundiais, além de
                diversos prêmios na área de telecomunicações.
              </p>
              <div class="-mx-3 flex items-center">
                ...
                <a
                  href="https://www.linkedin.com/company/telecall/jobs/"
                  class="px-3 text-[#dddddd] hover:text-white"
                >
                  <svg
                    width="18"
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">Sobre Nós</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
          ...
          <div class="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white">Rede e Infraestrutura</h4>
              <ul>
                <li>
                  <a
                    href="javascript:void(0)"
            ...
            <div class="w-full px-4 md:w-1/3 lg:w-1/2">
              <div class="my-1 flex justify-center md:justify-end">
                <p class="text-base text-[#f3f4fe]">
                  ...
                  <a
                    href="https://github.com/Apolock33"
                    rel="nofollow noopner"
                    target="_blank"
